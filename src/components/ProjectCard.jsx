...
import { arrowOutward } from '../assets';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className=" w-11 h-11 grid place-items-center bg-sky-400 rounded-lg shrink-0">
          <img className="h-5" src={arrowOutward} alt="arrow outward" />
        </div>
      </div>
