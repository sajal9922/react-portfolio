          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className=" h-12 w-12 grid place-items-center ring-2 ring-inset ring-zinc-50/5 rounded-lg trsnsition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              required
              placeholder="Hi!"
              className="text-field text-resize-y min-h-32 max-h-80"
            ></textarea>
          </div>
          <button
            type="submit"
